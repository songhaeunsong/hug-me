    ...
    <BottomButtonLayout onClickButton={handleClickButton} buttonText={'적정 보증금 평균값 보기'}>
      <div className="flex flex-col h-full pt-12 pb-28 px-4 gap-12">
        <p className="text-[24px] font-bold text-start">
          적정 보증금을 확인고자 하는 매물의 <span className="text-point">매매가</span>를 입력해주세요.
        </p>
          ...
          <div className="flex flex-col w-full items-start gap-4">
            <div className="flex gap-2 items-center w-full">
              <input
                ...
                className="w-full px-1 py-[4px] outline-none border-0 border-b-1 border-gray-1 text-[20px] text-dark shadow-none rounded-none"
              />
