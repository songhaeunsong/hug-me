...
interface QuizAfterContractProps {
  resetQuizState: () => void;
}

const TOTAL_COUNT = 10;

export const QuizAfterContract = ({ resetQuizState }: QuizAfterContractProps) => {
  const { data: quizes, isPending, isError, isFetching } = useGetQuizes('계약후');
