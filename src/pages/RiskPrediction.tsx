...
type RiskPredictionState = 'HOUSE_PRICE' | 'HOUSE_SENIORITY' | 'HOUSE_TYPE' | 'GUARANTEE_MONTH' | 'RESULT';

export const RiskPrediction = () => {
  const [riskPredictionState, setRiskPredictionState] = useState<RiskPredictionState>('HOUSE_PRICE');
